...
CREATE TABLE booking (
  ...
  CONSTRAINT users_fk_booking FOREIGN KEY (user_id) REFERENCES users(user_id) ON UPDATE CASCADE,
...
INSERT INTO booking (user_id, tech_id, status_id, address_id, message, service_date, expected_time) VALUES
